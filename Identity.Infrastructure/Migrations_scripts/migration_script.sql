...
IF (SELECT MigrationId FROM [dbo].[__EFMigrationsHistory] WHERE MigrationId = '20250516205537_InitialMigration') IS NOT NULL
	RETURN;
...
VALUES (N'20250516205537_InitialMigration', N'9.0.4');
